...
<body>
  ...
  <?php include 'includes/adminpannel-header.php' ?>
    ...
    <div class="container">
        <aside class="sidebar">
            <form action='savedproduct.php' method='post' id="productForm" enctype="multipart/form-data">
        ...
        <main class="main-content">
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo "<td><img src='showimage.php?id={$row['product_id']}' width='`100' height='100'></td>";
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      rows.forEach(row => {
        row.addEventListener("click", function() {
          ...
          document.querySelector("input[name='product_id']").value = cells[0].textContent;
          document.querySelector("input[name='product_name']").value = cells[1].textContent;
          document.querySelector("input[name='product_image']").value = cells[2].textContent;
          document.querySelector("input[name='price']").value = cells[3].textContent;
          document.querySelector("input[name='stocks']").value = cells[4].textContent;
        });
      });
    });
